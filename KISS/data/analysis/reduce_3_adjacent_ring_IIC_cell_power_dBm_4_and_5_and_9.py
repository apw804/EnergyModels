...
# Group by reduced_cell_4_power (and cell 5 and cell 9) for the whole network
...
# Group by reduced_cell_4_power (and cell 5 and cell 9) AND serving_cell_id for the inner ring cells
...
# Group by reduced_cell_4_power (and cell 5 and cell 9) AND serving_cell_id for the other cells
...
# Set figure title
fig.suptitle(f'Effects of reducing the output power (dBm) of cell 4, cell 5 and cell 9 on the network', fontsize=16)
...
ax[0,0].errorbar(df_reduced_power_cells['reduced_cell_4_power'],
            ...
            capsize=2,
            linewidth=1,
            label='Reduced Tx Power Cells Mean (IIC)',
)
...
ax[0,0].legend()
ax[0,0].grid(True)
ax[0,0].set_title('Cell Throughput vs Reduced Tx Cell (4 & 5 & 9) Power')
...
ax[0,1].legend()
ax[0,1].grid(True)
ax[0,1].set_title('Cell Power vs Reduced Tx Cell (4 & 5 & 9) Power')
...
ax[1,0].legend()
ax[1,0].grid(True)
ax[1,0].set_title('Cell EE vs Reduced Tx Cell (4 & 5 & 9) Power')
...
ax[1,1].legend()
ax[1,1].grid(True)
ax[1,1].set_title('Cell SE vs Reduced Tx Cell (4 & 5 & 9) Power')
...
# Save the figure
fig.savefig('2023_05_03T_r3acp_cell_vs_reduced_tx_cell_4_and_5_and_9_power_dBm.pdf', dpi=300, format='pdf', bbox_inches='tight')
