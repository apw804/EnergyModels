...
# Set figure title
fig.suptitle(f'Effects of reducing the output power (watts) of cell 1, cell 4 and cell 5 on the network', fontsize=16)
...
ax[0,0].errorbar(df_reduced_power_cells['reduced_cell_1_power_watts'],
...
ax[0,0].errorbar(df_full_power_cells['reduced_cell_1_power_watts'],
...
ax[0,1].errorbar(df_reduced_power_cells[df_reduced_power_cells['reduced_cell_1_power'] != -999]['reduced_cell_1_power_watts'],
...
ax[0,1].errorbar(df_full_power_cells['reduced_cell_1_power_watts'],
...
ax[1,0].errorbar(df_reduced_power_cells['reduced_cell_1_power_watts'],
...
ax[1,0].errorbar(df_full_power_cells['reduced_cell_1_power_watts'],
...
ax[1,1].errorbar(df_reduced_power_cells['reduced_cell_1_power_watts'],
...
ax[1,1].errorbar(df_full_power_cells['reduced_cell_1_power_watts'],
...
# Save the figure
fig.savefig('2023_05_03T_r3acp_cell_vs_reduced_tx_cell_1_and_4_and_5_power_watts.pdf', dpi=300, format='pdf', bbox_inches='tight')
