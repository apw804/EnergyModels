...
# Save the figure
fig.savefig(project_path / 'data' / 'figures'  / '2023_04_12_mean_ues_attached_to_cells_for_different_cell_9_power_levels_to_zero_watts_best_SINR.pdf', format='pdf')