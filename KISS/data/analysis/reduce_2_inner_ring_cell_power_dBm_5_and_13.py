...
data_path = project_path / 'data' / 'output' / 'reduce_cell_5_and_13_power' / '2023_04_26'
rcp_data = data_path
cells_turned_down = []
...
# Group by reduced_cell_5_power (and cell_10) for the whole network
...
# Group by reduced_cell_5_power (also cell_10) AND serving_cell_id for the inner ring cells
...
# Group by reduced_cell_5_power (also cell_10) AND serving_cell_id for the other cells
...
# Set figure title
fig.suptitle(f'Effects of reducing the output power (dBm) of cell 5 and cell 13 on the network', fontsize=16)
...
ax[0,0].errorbar(df_reduced_power_cells['reduced_cell_5_power'],
...
ax[0,0].errorbar(df_full_power_cells['reduced_cell_5_power'],
...
ax[0,0].legend()
ax[0,0].grid(True)
ax[0,0].set_title('Cell Throughput vs. Reduced Tx Cell (5 & 13) Power')
...
ax[0,1].errorbar(df_reduced_power_cells[df_reduced_power_cells['reduced_cell_5_power'] != -999]['reduced_cell_5_power'],
...
sleep_power_watts = df_reduced_power_cells[df_reduced_power_cells['reduced_cell_5_power'] == -999]['reduced_cell_5_power']
ax[0,1].plot(0,
            df_reduced_power_cells[df_reduced_power_cells['reduced_cell_5_power'] == -999]['cell_power(kW)_mean_mean'],
            marker='o',
            markersize=5,
...
ax[0,1].errorbar(df_full_power_cells['reduced_cell_5_power'],
...
ax[0,1].legend()
ax[0,1].grid(True)
ax[0,1].set_title('Cell Power vs. Reduced Tx Cell (5 & 13) Power')


# CELL EE (bits/J)
ax[1,0].errorbar(df_reduced_power_cells['reduced_cell_5_power'],
...
ax[1,0].errorbar(df_full_power_cells['reduced_cell_5_power'],
...
ax[1,0].legend()
ax[1,0].grid(True)
ax[1,0].set_title('Cell EE vs. Reduced Tx Cell (5 & 13) Power')


# CELL SE (bits/Hz)
ax[1,1].errorbar(df_reduced_power_cells['reduced_cell_5_power'],
...
ax[1,1].errorbar(df_full_power_cells['reduced_cell_5_power'],
...
ax[1,1].legend()
ax[1,1].grid(True)
ax[1,1].set_title('Cell SE vs. Reduced Tx Cell (5 & 13) Power')
...
# Save the figure
fig.savefig('2023_05_03T_r2irp_cell_vs_reduced_tx_cell_5_and_13_power_dBm.pdf', dpi=300, format='pdf', bbox_inches='tight')

print(df_reduced_power_cells['reduced_cell_5_power'])
