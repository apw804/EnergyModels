...
data_path = project_path / 'data' / 'output' / 'reduce_Y_cell_4_and_10_and_13_power' / '2023_05_03'
rcp_data = data_path
cells_turned_down = []
...
# Group by reduced_cell_4_power (and cell 10 and cell 13) for the whole network
...
# Group by reduced_cell_4_power (and cell 10 and cell 13) AND serving_cell_id for the inner ring cells
...
# Group by reduced_cell_4_power (and cell 10 and cell 13) AND serving_cell_id for the other cells
...
# Set figure title
fig.suptitle(f'Effects of reducing the output power (dBm) of cell 4, cell 10 and cell 13 on the network', fontsize=16)
...
ax[0,0].legend()
ax[0,0].grid(True)
ax[0,0].set_title('Cell Throughput vs Reduced Tx Cell (4 & 10 & 13) Power')
...
ax[0,1].legend()
ax[0,1].grid(True)
ax[0,1].set_title('Cell Power vs Reduced Tx Cell (4 & 10 & 13) Power')
...
ax[1,0].legend()
ax[1,0].grid(True)
ax[1,0].set_title('Cell EE vs Reduced Tx Cell (4 & 10 & 13) Power')
...
ax[1,1].legend()
ax[1,1].grid(True)
ax[1,1].set_title('Cell SE vs Reduced Tx Cell (4 & 10 & 13) Power')
...
# Save the figure
fig.savefig('2023_05_03T_r3Ycp_cell_vs_reduced_tx_cell_4_and_10_and_13_power_dBm.pdf', dpi=300, format='pdf', bbox_inches='tight')
