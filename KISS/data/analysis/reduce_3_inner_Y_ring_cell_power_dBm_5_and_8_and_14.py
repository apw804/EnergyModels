...
# Set figure title
fig.suptitle(f'Effects of reducing the output power (dBm) of cell 5, cell 8 and cell 14 on the network', fontsize=16)
...
# Save the figure
fig.savefig('2023_05_03T_r3Ycp_cell_vs_reduced_tx_cell_5_and_8_and_14_power_dBm.pdf', dpi=300, format='pdf', bbox_inches='tight')
