...
# Set figure title
fig.suptitle(f'Effects of reducing the output power (watts) of cell 4, cell 5 and cell 9 on the network', fontsize=16)
...
# Save the figure
fig.savefig('2023_05_03T_r3acp_cell_vs_reduced_tx_cell_4_and_5_and_9_power_watts.pdf', dpi=300, format='pdf', bbox_inches='tight')
