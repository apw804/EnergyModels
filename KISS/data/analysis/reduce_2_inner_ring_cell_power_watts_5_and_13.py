...
for df, rcp_cells in df_generator:
    ...
    # Find dataframes where the serving_cell_id is 5 and the correspoding seed value is inf
...
# Group by reduced_cell_5_power (and cell_13) for the whole network
...
# Group by reduced_cell_5_power (also cell_13) AND serving_cell_id for the inner ring cells
...
# Group by reduced_cell_5_power (also cell_13) AND serving_cell_id for the other cells
...
# Set figure title
fig.suptitle(f'Effects of reducing the output power (watts) of cell 5 and cell 13 on the network', fontsize=16)
...
# Drop the value at `reduce_cell_5_power` of 0
...
# Save the figure
fig.savefig('2023_05_03T_r2irp_cell_vs_reduced_tx_cell_5_and_13_power_watts.pdf', dpi=300, format='pdf', bbox_inches='tight')
