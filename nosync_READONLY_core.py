...
#except:
#  print('scipy.spatial.KDTree not found - kdtree will not be used',file=stderr)
from AIMM_simulator.NR_5G_standard_functions_00 import CQI_to_64QAM_efficiency, SINR_to_CQI
from AIMM_simulator.UMa_pathloss_model_01 import UMa_pathloss
...
class Sim:
  ...
  def __init__(s,params={'fc_GHz':3.5,'h_UT':2.0,'h_BS':20.0},show_params=True,rng_seed=0):
    s.__version__=basename(__file__)[-5:-3] # get version number from filename
    s.params=params
