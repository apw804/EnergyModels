...
# Group by reduced_cell_0_power (also cell 1 and cell 4) AND serving_cell_id for the inner ring cells
...
# Group by reduced_cell_0_power (also cell 1 and cell 4) AND serving_cell_id for the other cells
...
# Set figure title
fig.suptitle(f'Effects of reducing the output power (watts) of cell 0, cell 1 and cell 4 on the network', fontsize=16)
...
# Save the figure
fig.savefig('2023_05_03T_r3acp_cell_vs_reduced_tx_cell_0_and_1_and_4_power_watts.pdf', dpi=300, format='pdf', bbox_inches='tight')
