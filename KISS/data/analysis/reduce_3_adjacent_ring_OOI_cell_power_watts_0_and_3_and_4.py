...
# Group by reduced_cell_0_power (and cell 1 and cell 4) for the whole network
...
# Group by reduced_cell_0_power (also cell 3 and cell 4) AND serving_cell_id for the inner ring cells
...
# Group by reduced_cell_0_power (also cell 3 and cell 4) AND serving_cell_id for the other cells
...
# Set figure title
fig.suptitle(f'Effects of reducing the output power (watts) of cell 0, cell 3 and cell 4 on the network', fontsize=16)
...
ax[0,0].errorbar(df_reduced_power_cells['reduced_cell_0_power_watts'],
...
ax[0,0].errorbar(df_full_power_cells['reduced_cell_0_power_watts'],
...
ax[0,1].errorbar(df_reduced_power_cells[df_reduced_power_cells['reduced_cell_0_power'] != -999]['reduced_cell_0_power_watts'],
...
sleep_power_watts = df_reduced_power_cells[df_reduced_power_cells['reduced_cell_0_power'] == -999]['reduced_cell_0_power_watts']
ax[0,1].plot(0,
            df_reduced_power_cells[df_reduced_power_cells['reduced_cell_0_power'] == -999]['cell_power(kW)_mean_mean'],
            marker='o',
            markersize=5,
...
ax[0,1].errorbar(df_full_power_cells['reduced_cell_0_power_watts'],
...
ax[1,0].errorbar(df_reduced_power_cells['reduced_cell_0_power_watts'],
...
ax[1,0].errorbar(df_full_power_cells['reduced_cell_0_power_watts'],
...
ax[1,1].errorbar(df_reduced_power_cells['reduced_cell_0_power_watts'],
...
ax[1,1].errorbar(df_full_power_cells['reduced_cell_0_power_watts'],
...
# Save the figure
fig.savefig('2023_05_03T_r3acp_cell_vs_reduced_tx_cell_0_and_3_and_4_power_watts.pdf', dpi=300, format='pdf', bbox_inches='tight')
