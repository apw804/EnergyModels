...
for df, rcp_cells in df_generator:
    ...
    # Find dataframes where the serving_cell_id is 4 and the correspoding seed value is inf
...
# Set figure title
fig.suptitle(f'Effects of reducing the output power (watts) of cell 4 and cell 14 on the network', fontsize=16)
...
ax[0,0].errorbar(df_reduced_power_cells['reduced_cell_4_power_watts'],
...
ax[0,0].errorbar(df_full_power_cells['reduced_cell_4_power_watts'],
...
# Drop the value at `reduce_cell_4_power` of 0
...
ax[0,1].errorbar(df_reduced_power_cells[df_reduced_power_cells['reduced_cell_4_power'] != -999]['reduced_cell_4_power_watts'],
...
ax[0,1].errorbar(df_full_power_cells['reduced_cell_4_power_watts'],
...
ax[1,0].errorbar(df_reduced_power_cells['reduced_cell_4_power_watts'],
...
ax[1,0].errorbar(df_full_power_cells['reduced_cell_4_power_watts'],
...
ax[1,1].errorbar(df_reduced_power_cells['reduced_cell_4_power_watts'],
...
ax[1,1].errorbar(df_full_power_cells['reduced_cell_4_power_watts'],
...
# Save the figure
fig.savefig('2023_05_03T_r2irp_cell_vs_reduced_tx_cell_4_and_14_power_watts.pdf', dpi=300, format='pdf', bbox_inches='tight')
