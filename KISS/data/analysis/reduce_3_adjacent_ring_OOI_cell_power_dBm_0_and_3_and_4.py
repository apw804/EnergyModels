...
data_path = project_path / 'data' / 'output' / 'reduce_adjacent_cell_0_and_3_and_4_power' / '2023_04_26'
rcp_data = data_path
cells_turned_down = []
...
# Set figure title
fig.suptitle(f'Effects of reducing the output power (dBm) of cell 0, cell 3 and cell 4 on the network', fontsize=16)
...
ax[0,0].legend()
ax[0,0].grid(True)
ax[0,0].set_title('Cell Throughput vs. Reduced Tx Cell (0 & 3 & 4) Power')
...
ax[0,1].legend()
ax[0,1].grid(True)
ax[0,1].set_title('Cell Power vs. Reduced Tx Cell (0 & 3 & 4) Power')
...
ax[1,0].legend()
ax[1,0].grid(True)
ax[1,0].set_title('Cell EE vs. Reduced Tx Cell (0 & 3 & 4) Power')
...
ax[1,1].legend()
ax[1,1].grid(True)
ax[1,1].set_title('Cell SE vs. Reduced Tx Cell (0 & 3 & 4) Power')
...
# Save the figure
fig.savefig('2023_05_03T_r3acp_cell_vs_reduced_tx_cell_0_and_3_and_4_power_dBm.pdf', dpi=300, format='pdf', bbox_inches='tight')
