...
# Set figure title
fig.suptitle(f'Effects of reducing the output power (watts) of cell 8 and cell 10 on the network', fontsize=16)
...
ax[0,0].errorbar(df_reduced_power_cells['reduced_cell_8_power_watts'],
...
ax[0,0].errorbar(df_full_power_cells['reduced_cell_8_power_watts'],
...
ax[0,0].legend()
ax[0,0].grid(True)
ax[0,0].set_title('Cell Throughput vs Reduced Tx Cell 8 Power')
...
ax[0,1].errorbar(df_reduced_power_cells[df_reduced_power_cells['reduced_cell_8_power'] != -999]['reduced_cell_8_power_watts'],
...
sleep_power_watts = df_reduced_power_cells[df_reduced_power_cells['reduced_cell_8_power'] == -999]['reduced_cell_8_power_watts']
ax[0,1].plot(0,
            df_reduced_power_cells[df_reduced_power_cells['reduced_cell_8_power'] == -999]['cell_power(kW)_mean_mean'],
            marker='o',
            markersize=5,
...
ax[0,1].errorbar(df_full_power_cells['reduced_cell_8_power_watts'],
...
ax[0,1].legend()
ax[0,1].grid(True)
ax[0,1].set_title('Cell Power vs Reduced Tx Cell 8 Power')



ax[1,0].errorbar(df_reduced_power_cells['reduced_cell_8_power_watts'],
...
ax[1,0].errorbar(df_full_power_cells['reduced_cell_8_power_watts'],
...
ax[1,0].legend()
ax[1,0].grid(True)
ax[1,0].set_title('Cell EE vs Reduced Tx Cell 8 Power')



ax[1,1].errorbar(df_reduced_power_cells['reduced_cell_8_power_watts'],
...
ax[1,1].errorbar(df_full_power_cells['reduced_cell_8_power_watts'],
...
ax[1,1].legend()
ax[1,1].grid(True)
ax[1,1].set_title('Cell SE vs Reduced Tx Cell 8 Power')
...
# Save the figure
fig.savefig('2023_05_03T_r2irp_cell_vs_reduced_tx_cell_8_and_10_power_watts.pdf', dpi=300, format='pdf', bbox_inches='tight')
