...
if __name__ == '__main__':  # a simple self-test
    ...
    parser.add_argument('-fc_GHz', type=float, default=3.50,
                        help='Centre frequency in GHz')
    parser.add_argument('-h_UT', type=float, default=2.0,
    ...
    parser.add_argument('-power_dBm', type=float, default=45.0,
    ...
    parser.add_argument('-until', type=float, default=22.0,
    ...
    parser.add_argument('-experiment_name', type=str, default='TestCQI_2',
